...
const svc = __importStar(require("./futureMessage.service"));
...
exports.create = wrap(async (req) => {
    ...
    return svc.createMessage(userId || '', req.body, req.files || []);
});
exports.getAll = wrap(async (req) => {
    const { userId } = (0, express_1.getAuth)(req);
    return svc.getAllMessages(userId || '');
});
exports.getOne = wrap(async (req) => {
    const { userId } = (0, express_1.getAuth)(req);
